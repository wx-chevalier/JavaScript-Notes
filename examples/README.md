...
JS & TS Snippets. 该项目承接自 [fe-boilerplates](https://github.com/wx-chevalier/fe-boilerplates)。

- [declarative-validator](./packages/declarative-validator): Declarative Validator

- [x-fetch](./packages/x-fetch): Extreme and Fluent Wrapper for fetch.

- [dockerode-ts-promise](./packages/dockerode-ts-promise): [Dockerode](https://github.com/apocas/dockerode) wrapped in TypeScript

- [typed-entity-decorators](./packages/typed-entity-decorators): Decorate once, use everywhere, entity decorators for JS/TS, to enable GraphQL, Swagger, etc.
